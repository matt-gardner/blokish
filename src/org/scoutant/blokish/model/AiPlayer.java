...
// TODO(matt): can we remove these Android dependencies from here?  That's a much later TODO,
// though
...
public class AiPlayer implements Player {
    ...
    public AiPlayer(int playerNum, int level, Game game) {
    ...
    public class AITask extends AsyncTask<Integer, Void, Move> {
        ...
        public AITask(MoveCallback callback) {
            this.callback = callback;
        }

        @Override
        protected Move doInBackground(Integer... params) {
            return think(params[0], params[1]);
        }
    ...
    // TODO(matt): below here is the old AI class.  It could probably be cleaned up a bit.
